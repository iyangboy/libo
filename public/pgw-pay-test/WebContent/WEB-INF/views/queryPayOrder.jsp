...
<body>
	<div>
		...
		<form method="post" id="transForm" name="transForm" action="/pgw-pay-test/queryPayOrder/goQueryPayOrder">
			<table>
			   ...
			   <tr>
					...
					<td>
						<input type="radio" id="url_UAT" name="url" checked="checked"
							value="https://112.65.144.19:9204/pgw-pay/queryorder" />外网测试
							&nbsp;&nbsp;
					</td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" id="type" name="type" value="1" />0-全部；1-支付；2-退款；3-对公代付</td>
				</tr>

				<tr>
					<td height="24px">商户订单号：orderId:</td>
