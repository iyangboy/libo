...
<body>
	<div>
		...
		<form method="post" id="transForm" name="transForm" action="/pgw-pay-test/quickPay/signCancel">
			<table>
				...
				<tr>
					...
					<td>
						<input type="radio" id="url_UAT" name="url" checked="checked"
							value="https://112.65.144.19:9204/pgw-pay/quickpay/signcancel" />外网测试
					</td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" id="merchantId" name="merchantId" value="000011025" /></td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" id="protocolId" name="protocolId" value="201805129900006717" /></td>
				</tr>
