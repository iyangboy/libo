...
<body>
	<div>
		...
		<form method="post" id="transForm" name="transForm" action="${pageContext.request.contextPath}/authpay/authpayRefund">
			<table>
	
				<tr>
					<td height="24px">测试地址:</td>
					<td>
					 	<input type="radio" id="url_OUT" name="url" checked="checked"
							value="https://pay.zhengtongcf.com/pgw-quickpay/authpay/refund" />外网测试
					</td>
				</tr>
