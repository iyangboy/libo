...
<body>
	<div>
		...
		<form method="post" id="transForm" name="transForm" action="${pageContext.request.contextPath}/payment/doPay">
			<table>
				...
				<tr>
					...
					<td>
						<input type="radio" id="url_UAT" name="url" checked="checked"
							value="https://112.65.144.19:9204/pgw-pay/pay" />外网测试
							&nbsp;&nbsp;
					</td>
				</tr>
				...
				<tr>
					<td height="24px">手机号码:</td>
					<td><input type="text" id="mobile" name="mobile" value="13028011546" /></td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="busiType" name="busiType">
							<option value="00" selected="selected">消费</option>
						</select>
					</td>
				</tr>

				<tr>
					<td height="24px">产品名称:</td>
					<td><input type="text" id="proName" name="proName" value="" /></td>
				</tr>
