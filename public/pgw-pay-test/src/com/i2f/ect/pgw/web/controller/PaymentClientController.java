...
public class PaymentClientController {
	...
	public static final Logger logger = LoggerFactory.getLogger(PaymentClientController.class);
	
	public static String LOCALHOST_URL = "https://www.tongtongcf.com:9204/pgw-pay/pay";
	...
	public ModelAndView doPay(HttpServletRequest request) throws UnsupportedEncodingException, IllegalAccessException, InstantiationException, InvocationTargetException, NoSuchMethodException{
		...
		String xmlString = ECTXmlUtil.mapToXml(map, ECTXmlUtil.CPREQ_CPREQ);
