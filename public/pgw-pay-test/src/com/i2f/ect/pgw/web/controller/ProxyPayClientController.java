...
public class ProxyPayClientController {
	
	public static final Logger logger = LoggerFactory.getLogger(ProxyPayClientController.class);
	
	public static String LOCALHOST_URL = "https://www.tongtongcf.com:9204/pgw-pay/charge";
	...
	@RequestMapping("/proxyPayPage")
	public ModelAndView goBindCardpage(){
		ModelAndView model = new ModelAndView("proxyPay");
		return model;
	}
