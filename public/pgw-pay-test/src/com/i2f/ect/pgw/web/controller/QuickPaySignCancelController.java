...
public class QuickPaySignCancelController {
public static final Logger logger = LoggerFactory.getLogger(QuickPaySignCancelController.class);
	...
	public ModelAndView doPay(HttpServletRequest request) throws UnsupportedEncodingException, IllegalAccessException, InstantiationException, InvocationTargetException, NoSuchMethodException{
		String LOCALHOST_URL = "http://localhost:8080/pgw-pay/quickpay/signcancel";
		...
		String xmlString = ECTXmlUtil.mapToXml(map, ECTXmlUtil.CPREQ_SCREQ);
	...
	@RequestMapping("/signCancelPage")
	public ModelAndView senddo(){
		logger.info("进入解约接口");
		ModelAndView model = new ModelAndView("quickPaySignCancel");
		return model;
	}
}
