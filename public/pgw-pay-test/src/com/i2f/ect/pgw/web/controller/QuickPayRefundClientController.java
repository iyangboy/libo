...
public class QuickPayRefundClientController {
	
	public static final Logger logger = LoggerFactory.getLogger(PayRefundClientController.class);
	public static String LOCALHOST_URL = "http://localhost:9080/pgw-pay/quickpay/refund";
	
	//直接以Http post请求方式，请求证通对应接口
	@RequestMapping("/quickPayRefund")  
	...
	@RequestMapping("/quickPayRefundPage")
	public ModelAndView goBindCardpage(){
		ModelAndView model = new ModelAndView("quickPayRefund");
		return model;
	}
