...
public class QucikPayIdentifyAuthController {
public static final Logger logger = LoggerFactory.getLogger(QucikPayIdentifyAuthController.class);

	//新的方法中直接以Http Post请求方式，请求证通对应接口
	@RequestMapping("/identifyauth")  
	public ModelAndView identityAuth(HttpServletRequest request) throws Exception{
		String url = "http://localhost:8080/pgw-pay/quickpay/identifyauth";
	...
	@RequestMapping("/identifyAuthPage")
	public ModelAndView signPage(){
		logger.info("进入签约接口");
		ModelAndView model = new ModelAndView("quickPayIdentifyAuth");
		return model;
	}
