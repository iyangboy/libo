...
@Controller
@RequestMapping("/quickPayValidate")
public class QuickPayValidateClientController {
	
	public static final Logger logger = LoggerFactory.getLogger(QuickPayValidateClientController.class);
...
//	public static String LOCALHOST_URL = "http://11.8.37.17:9080/pgw-pay/payment/doPay";
	...
	@RequestMapping("/quickPayValidatePage")
	public ModelAndView goPayPage(){
		logger.info("进入快捷支付测试输入页面");
		ModelAndView model = new ModelAndView("quickPayValidate");
		return model;
	}
